...
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/aarondfrancis/image-proxy/tests.yaml?branch=main&label=tests&style=flat-square)](https://github.com/aarondfrancis/image-proxy/actions?query=workflow%3Atests+branch%3Amain)
